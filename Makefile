.PHONY: clean data lint requirements sync_data_to_s3 sync_data_from_s3 doc_reqs
...
BUCKET = deep-ml-curriculum-data
PROFILE = default
PROJECT_NAME = deep_ml_curriculum
...
doc_reqs:
	...
	conda env export  > requirements/environment.yaml
